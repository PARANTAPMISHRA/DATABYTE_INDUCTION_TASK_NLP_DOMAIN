...
#LOADING THE DATASET
data=pd.read_excel(r'C:\Users\pc\OneDrive\Desktop\MOVIE RECOMMENDATION SYSTEM WITH SCRAPED DATASET\model\DATASET_SCRAPPED_FROM_IMDb..xlsx')
movie_names=list(data['title'])

#LOADING THE COSINE_SIMILARITY_VECTORS
cosine_similarty_vectors=pd.read_pickle(r'C:\Users\pc\OneDrive\Desktop\MOVIE RECOMMENDATION SYSTEM WITH SCRAPED DATASET\model\cosine_similarity_vectors_for_web_scrapped_dataset.pkl')
